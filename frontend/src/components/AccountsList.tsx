...
const AccountsList: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden text-slate-600">
          ...
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              >
                {isProcessing ? (
                  <>
                    <div className="h-3 w-3 border-2 border-[#E67E22]/30 border-t-[#E67E22] rounded-full animate-spin" />
      ...
      <div className="px-6 py-4 border-b border-yellow-100/50 bg-gray-50/30 flex justify-start items-center">
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-gray-50">
            {users.map((u, index) => (
              ...
              >
                <td className="px-6 py-3 text-[11px]">{u.name}</td>
                ...
                {isSuperAdmin && (
                  <td className="px-6 py-3 text-center">
                    <select 
                      ...
                      className="text-[10px] border-gray-200 border px-2 py-1 rounded-lg bg-white/50 focus:bg-yellow-50 focus:border-yellow-200 cursor-pointer outline-none transition-all hover:border-yellow-200"
                    >
